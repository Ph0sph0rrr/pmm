...
pass;
        ...
        public reg()
        {
            ...
            napravbak.Items.Add("прикладная математика и информатика");
            napravbak.Items.Add("психология");
            napravbak.Items.Add("экономика");
            napravbak.Items.Add("управление персоналом");


            napravmag.Items.Add("Геология");
            napravmag.Items.Add("Биология");
            napravmag.Items.Add("Радиотехника");
            napravmag.Items.Add("Технологические машины и оборудование");

            napravspec.Items.Add("техника и инженерия");
            napravspec.Items.Add("экономика и финансы");
            napravspec.Items.Add("филология и лингвистика");
            napravspec.Items.Add("медицина");

            napravspo.Items.Add("Науки о земле");
            napravspo.Items.Add("Архитектура");
            napravspo.Items.Add("Ядерная энергетика и технологии");
            napravspo.Items.Add("Машиностроение");
